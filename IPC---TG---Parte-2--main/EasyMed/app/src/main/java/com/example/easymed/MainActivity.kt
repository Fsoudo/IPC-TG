...
import com.example.easymed.ecras.francisco.EcraAlerta
...
fun AppEasyMed() {
    ...
    when (ecraAtual) {
        ...
        // mostra o alerta bloqueado F1
        "f1_alerta" -> EcraAlerta(
            // a toma ignorada que disparou o alerta
            tomaId = DadosApp.tomaSelecionadaId,
            // "Ver detalhe" -> F3
            ...
            // espaço que o Scaffold reserva (para não tapar)
                ...
                Box(
                    ...
                    when (ecraAtual) {
                        ...
                        "hoje" -> EcraHoje(
                            // ação do botão "Simular Alarme"
                            aoSimularAlarme = { tomaId ->
                                // guarda qual a toma do alarme
                                DadosApp.tomaSelecionadaId = tomaId
                                // abre o ecrã bloqueado M1
                        ...
                        "inicio" -> EcraDashboard(
                            ...
                            aoVerDetalhe = { ecraAtual = "f3_detalhe" },
                            // ação do botão "Simular toma ignorada"
                            aoSimularIgnorada = { tomaId ->
                                // guarda a toma ignorada
                                DadosApp.tomaSelecionadaId = tomaId
                                // abre o alerta F1
                                ecraAtual = "f1_alerta"
                            }
